...
These constructions are **informal** as there is no definition of a
*class*.
...
RSS &= {e^T}e = \left[ {\begin{array}{*{20}{c} }
  { {e_1} }&{ {e_2} }& \cdots &{ {e_N} } 
\end{array} } \right]_{1 \times 1}\left[ {\begin{array}{*{20}{c} }
  { {e_1} } \\ 
  { {e_2} } \\ 
   \vdots  \\ 
  { {e_N} } 
...
\[\begin{aligned}
  Cov\left( {\hat \beta } \right) &= E\left[ {\left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}y - \beta } \right){ {\left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}y - \beta } \right)}^T} } \right] \hfill \\
   &= E\left[ \begin{gathered}
  \left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\left( {X\beta  + \varepsilon } \right) - \beta } \right) \hfill \\
  {\left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\left( {X\beta  + \varepsilon } \right) - \beta } \right)^T} \hfill \\ 
\end{gathered}  \right] \hfill \\
   &= E\left[ \begin{gathered}
  \left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}X\beta  + { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon  - \beta } \right) \hfill \\
  {\left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}X\beta  + { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon  - \beta } \right)^T} \hfill \\ 
\end{gathered}  \right] \hfill \\
   &= E\left[ {\left( {\beta  + { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon  - \beta } \right){ {\left( {\beta  + { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon  - \beta } \right)}^T} } \right] \hfill \\
\end{aligned} \]

## Covariance of the LS Estimator for MLR

\[\begin{aligned}
  Cov\left( {\hat \beta } \right) &= E\left[ {\left( {\beta  + { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon  - \beta } \right){ {\left( {\beta  + { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon  - \beta } \right)}^T} } \right] \hfill \\
   &= E\left[ {\left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon } \right){ {\left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon } \right)}^T} } \right] \hfill \\ 
   &= E\left[ {\left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon } \right){ {\left( { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon } \right)}^T} } \right] \\
   &= E\left[ { { {\left( { {X^T}X} \right)}^{ - 1} }{X^T}\varepsilon {\varepsilon ^T}{ {\left( { {X^T}X} \right)}^{ - 1} }{X^T} } \right] \\
...
Cov\left( {\hat \beta } \right) &=  {\left( { {X^T}X} \right)^{ - 1} }{X^T}\operatorname{var} \left( \varepsilon  \right)X{\left( { {X^T}X} \right)^{ - 1} } \\
   ...
   &= {\sigma ^2}{\left( { {X^T}X} \right)^{ - 1} }{X^T}\left( I \right)X{\left( { {X^T}X} \right)^{ - 1} } \\
   &= {\sigma ^2}{\left( { {X^T}X} \right)^{ - 1} }{X^T}X{\left( { {X^T}X} \right)^{ - 1} } \\
   &= {\sigma ^2}{\left( { {X^T}X} \right)^{ - 1} } \\ 
\end{aligned} \]

**Note:** Under Least Squares, we assume that \[\operatorname{var} \left( \varepsilon  \right) = {\sigma ^2}{I_n}\]
...
- We can control how the summary generic function should look on print via
`print.summary.my_lm`.
