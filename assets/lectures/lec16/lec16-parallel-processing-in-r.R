...
## ----rpi_cluster, out.width = "200px", fig.retina = NULL, fig.align='center', cache = TRUE, echo = FALSE----
knitr::include_graphics("img/rpicluster.jpg")

## ----head_vs_workers, out.width = "200px", fig.retina = NULL, fig.align='center', cache = TRUE, echo = FALSE----
...
## ----parallel_doc, out.width = "300px", fig.retina = NULL, fig.align='center', cache = TRUE, echo = FALSE----
